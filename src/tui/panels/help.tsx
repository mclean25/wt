...
const KEY_BLOCKS: Block[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: "ctrl+shift+a", label: "clear all queued automations; running actions are untouched" },
  ...
  },
  {
    ...
    items: [
      ...
      { key: "< / > / \\", label: "slot palette for wt / main / dotfiles — continue (g), compact (m), open in editor (z), custom message (c)" },
      { key: "O", label: "open main repo in editor" },
  ...
  },
  {
    ...
    items: [
      ...
      { key: "ctrl+shift+j/k", label: "scroll the event feed (ctrl+e/y and mouse wheel too); it re-follows at the bottom" },
